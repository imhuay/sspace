过拟合与正则化 <!-- suffix --> <span title="TODO">✒️</span> <!-- suffix -->
===
<!--START_SECTION:badge-->
...
- [常见正则化方法](#常见正则化方法)
    ...
    - [为损失函数添加正则化项](#为损失函数添加正则化项)
        - [L1 正则化](#l1-正则化)
        - [L2 正则化](#l2-正则化)
    - [提前结束训练 (Early Stopping)](#提前结束训练-early-stopping)
    - [Dropout](#dropout)
        - [常见问题](#常见问题)
            - [Dropout 在训练和测试时有什么区别? 为什么?](#dropout-在训练和测试时有什么区别-为什么)
...
<div align='center'><a href='_formulas/过拟合与正则化/f_001.js.tex'><img src='_formulas/过拟合与正则化/f_001.js.svg'/></a></div>

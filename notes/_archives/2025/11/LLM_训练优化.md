...
topic: '训练优化'  # 默认取文档的 toc_title, 如果有层级结构, 用 · 分隔, 如 'SFT · PEFT'
...
- [1. 🏷️ 数据层优化](#1-️-数据层优化)
- [2. 🏷️ 模型结构优化](#2-️-模型结构优化)
- [3. 🏷️ 优化算法与超参数优化](#3-️-优化算法与超参数优化)
- [4. 🏷️ 正则与泛化性优化](#4-️-正则与泛化性优化)
    - [4.1. ✅ Dropout 的原理作用](#41--dropout-的原理作用)
    - [4.2. ✅ 为什么现代 LLM 中一般不使用 Dropout?](#42--为什么现代-llm-中一般不使用-dropout)
- [5. 🏷️ 计算与系统层优化](#5-️-计算与系统层优化)
<!--END_SECTION:qa_toc-->
